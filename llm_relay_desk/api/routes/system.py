...
async def health(request: Request) -> dict[str, Any]:
    ...
    return {
        ...
        "debug_logging_enabled": config.get("debug_logging_enabled", False),
        "debug_log_directory": str(runtime.debug_logs.resolve_directory(config)),
        "debug_log_retention_files": config.get("debug_log_retention_files", 100),
